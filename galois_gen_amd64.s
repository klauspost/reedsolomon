...
// func galMulAVX2_32(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2_32(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
	MOVQ         AX, X2
	MOVQ         low_base+0(FP), AX
	MOVQ         high_base+24(FP), BP
	MOVOU        (AX), X0
	MOVOU        (BP), X1
	SHRQ         $0x04, CX
	VINSERTI128  $0x01, X0, Y0, Y0
	VINSERTI128  $0x01, X1, Y1, Y1
	VPBROADCASTB X2, Y2
	TESTQ        CX, CX
	JZ           galMulAVX2_32_end
...
galMulAVX2_32_loop:
	...
	ADDQ    $0x20, BX
	DECQ    CX
	JNZ     galMulAVX2_32_loop

galMulAVX2_32_end:
	RET

// func galMulAVX2Xor_32(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2Xor_32(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
	...
	VPBROADCASTB X2, Y2
	TESTQ        CX, CX
	JZ           galMulAVX2Xor_32_end

galMulAVX2Xor_32_loop:
	VMOVDQU (DX), Y3
	VPSRLQ  $0x04, Y3, Y4
	VPAND   Y2, Y3, Y3
	VPAND   Y2, Y4, Y4
	...
	ADDQ    $0x20, BX
	DECQ    CX
	JNZ     galMulAVX2Xor_32_loop

galMulAVX2Xor_32_end:
	RET

// func galMulAVX2_64(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2_64(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
...
galMulAVX2_64_loop:
	...
	ADDQ    $0x40, BX
	DECQ    CX
	JNZ     galMulAVX2_64_loop

galMulAVX2_64_end:
	RET

// func galMulAVX2Xor_64(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2Xor_64(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
	...
	VPBROADCASTB X2, Y2
	TESTQ        CX, CX
	JZ           galMulAVX2Xor_64_end

galMulAVX2Xor_64_loop:
	VMOVDQU (DX), Y3
	VMOVDQU 32(DX), Y5
	VPSRLQ  $0x04, Y3, Y4
	VPAND   Y2, Y3, Y3
	...
	ADDQ    $0x40, BX
	DECQ    CX
	JNZ     galMulAVX2Xor_64_loop

galMulAVX2Xor_64_end:
	RET

// func galMulAVX2_128(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2_128(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
...
galMulAVX2_128_loop:
	...
	ADDQ    $0x80, BX
	DECQ    CX
	JNZ     galMulAVX2_128_loop

galMulAVX2_128_end:
	RET

// func galMulAVX2Xor_128(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2Xor_128(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
	...
	VPBROADCASTB X2, Y2
	TESTQ        CX, CX
	JZ           galMulAVX2Xor_128_end

galMulAVX2Xor_128_loop:
	VMOVDQU (DX), Y3
	VMOVDQU 32(DX), Y5
	VMOVDQU 64(DX), Y7
	VMOVDQU 96(DX), Y9
	...
	ADDQ    $0x80, BX
	DECQ    CX
	JNZ     galMulAVX2Xor_128_loop

galMulAVX2Xor_128_end:
	RET

// func galMulAVX2_192(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2_192(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
...
galMulAVX2_192_loop:
	...
	ADDQ    $0xc0, BX
	DECQ    CX
	JNZ     galMulAVX2_192_loop

galMulAVX2_192_end:
	RET

// func galMulAVX2Xor_192(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2Xor_192(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
	...
	VPBROADCASTB X2, Y2
	TESTQ        CX, CX
	JZ           galMulAVX2Xor_192_end

galMulAVX2Xor_192_loop:
	VMOVDQU (DX), Y3
	VMOVDQU 32(DX), Y5
	VMOVDQU 64(DX), Y7
	VMOVDQU 96(DX), Y9
	...
	ADDQ    $0xc0, BX
	DECQ    CX
	JNZ     galMulAVX2Xor_192_loop

galMulAVX2Xor_192_end:
	RET

// func galMulAVX2Xor_224(low []byte, high []byte, in []byte, out []byte)
// Requires: AVX, AVX2, SSE2
TEXT ·galMulAVX2Xor_224(SB), $0-96
	MOVQ         $0x0000000f, AX
	MOVQ         in_len+56(FP), CX
	MOVQ         in_base+48(FP), DX
	MOVQ         out_base+72(FP), BX
	...
	VPBROADCASTB X2, Y2
	TESTQ        CX, CX
	JZ           galMulAVX2Xor_224_end

galMulAVX2Xor_224_loop:
	VMOVDQU (DX), Y3
	VMOVDQU 32(DX), Y5
	VMOVDQU 64(DX), Y7
	VMOVDQU 96(DX), Y9
	...
	ADDQ    $0xe0, BX
	DECQ    CX
	JNZ     galMulAVX2Xor_224_loop

galMulAVX2Xor_224_end:
	RET
