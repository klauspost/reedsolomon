...
//
// Process 3 output rows in parallel from a total of 8 input rows
//
// func _galMulAVX512Parallel83(in, out [][]byte, matrix *[matrixSize83]byte, addTo bool)
TEXT ·_galMulAVX512Parallel83(SB), 7, $0
	MOVQ  in+0(FP), SI
	MOVQ  8(SI), R9              // R9: len(in)
	SHRQ  $6, R9                 // len(in) / 64
	TESTQ R9, R9
	JZ    done_avx512_parallel83
...
skip_avx512_parallel83:
	...
	SUBQ $1, R9
	JNZ  loopback_avx512_parallel83

done_avx512_parallel83:
	VZEROUPPER
	RET
