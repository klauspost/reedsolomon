...
func setupMatrix84(matrixRows [][]byte, inputOffset, outputOffset int, matrix *[(16 + 16) * dimIn * dimOut84]byte) {
...
func galMulAVX512Parallel82(in, out [][]byte, matrixRows [][]byte, inputOffset, outputOffset int) {
	...
	if done > 0 {
		...
		matrix82 := [(16 + 16) * dimIn * dimOut82]byte{}
...
func galMulAVX512Parallel84(in, out [][]byte, matrixRows [][]byte, inputOffset, outputOffset int) {
	...
	if done > 0 {
		...
		matrix84 := [(16 + 16) * dimIn * dimOut84]byte{}
