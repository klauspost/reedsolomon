...
func NewStream(dataShards, parityShards int, o ...Options) (StreamEncoder, error) {
...
func NewStreamC(dataShards, parityShards int, conReads, conWrites bool, o ...Options) (StreamEncoder, error) {
	enc, err := New(dataShards, parityShards, o...)
	if err != nil {
		return nil, err
	}
